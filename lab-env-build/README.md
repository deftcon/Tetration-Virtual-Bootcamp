...
> NOTE: Generating API keys can be accomplished by <a href="https://console.aws.amazon.com/iam/home" target="_blank">navigating to the Identity and Access Management (IAM) service in the AWS console.</a>  Under Users, select your user account and click on the `Security credentials` tab. 
