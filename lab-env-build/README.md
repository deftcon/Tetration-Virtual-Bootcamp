...
This lab environment builds three fully functional ecommerce web apps; One Windows-based, one Linux-based, and one container-based operating in a Kubernetes cluster. 
